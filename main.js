...
$.getJSON("https://gis.pusair-pu.go.id/api/v1/papua/infrastructure?id=12", function(pengamanPantai){
    L.geoJSON(pengamanPantai, {
...
$.getJSON("https://gis.pusair-pu.go.id/api/v1/papua/infrastructure?id=5", function(embung){
    L.geoJSON(embung, {
        pointToLayer: function (Feature, coordinates) {
...
$.getJSON("https://gis.pusair-pu.go.id/api/v1/papua/infrastructure?id=4", function(bendungan){
    L.geoJSON(bendungan, {
        pointToLayer: function (Feature, coordinates) {
...
$.getJSON("https://gis.pusair-pu.go.id/api/v1/papua/infrastructure?id=2", function(danau){
    L.geoJSON(danau, {
        pointToLayer: function (Feature, coordinates) {
...
// var overlayMaps = {
//     "Pengaman Pantai": pengamanPantai,
//     "Embung": embung
// };
